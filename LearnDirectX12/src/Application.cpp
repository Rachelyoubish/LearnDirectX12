...
const std::string windowClassName = "DX12RenderWindowClass";

using WindowPtr = std::shared_ptr<Window>;
using WindowMap = std::map< HWND, WindowPtr >;
using WindowNameMap = std::map< std::string, WindowPtr >;
...
{
    MakeWindow( HWND hWnd, const std::string& windowName, int clientWidth, int clientHeight, bool vSync )
...
void Application::Initialize()
{
    ...
    wc.hIcon = LoadIcon( m_hInstance, nullptr );
    wc.hbrBackground = (HBRUSH)( COLOR_WINDOW + 1 );
    wc.lpszMenuName = nullptr;
    wc.lpszClassName = windowClassName.c_str();
    wc.hIconSm = LoadIcon( m_hInstance, nullptr );
...
std::shared_ptr<Window> Application::CreateRenderWindow( const std::string& windowName, int clientWidth, int clientHeight, bool vSync )
{
    ...
    HWND hWnd = CreateWindow( windowClassName.c_str(), windowName.c_str(),
...
std::shared_ptr<Window> Application::GetWindowByName( const std::string& windowName )
{
