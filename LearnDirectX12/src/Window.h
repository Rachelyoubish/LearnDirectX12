...
public:
	...
	// Should this window utilize VSync.
	bool IsVSync() const;
	void SetVSync( bool vSync );
	void ToggleVSync();

	// Is this a windowed window or fullscreen?
	...
	// Returns the current back buffer index after present.
...
protected:
	...
	Window() = delete;
	Window( HWND hWnd, const std::string& windowName, int clientWidth, int clientHeight, bool vSync );
	virtual ~Window();
