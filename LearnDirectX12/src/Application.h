...
public:
    ...
    // Create a new DirectX 12 render window instance.
    std::shared_ptr<Window> CreateRenderWindow( const std::string& windowName, int clientWidth, int clientHeight, bool vSync = true );
    ...
    */
    ...
    // exitCode - The error code to return to the invoking process.
