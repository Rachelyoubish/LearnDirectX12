...
// The Game class is the abstract base class for DirectX 12 demos.
...
class Window; // Could include the Window.h (ours, not MS) header instead.

class Game : public std::enable_shared_from_this<Game>
{
public:
	// Create the DirectX 12 demo using the specified window dimensions.
	Game( const std::string& name, int width, int height, bool vSync );
	virtual ~Game();
	...
	// Destroy and resource that are used by the game.
